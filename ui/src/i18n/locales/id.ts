...
export const id: TranslationMap = {
  ...
  newSession: {
    ...
    incognito: "Incognito",
    incognitoDescription: "Simpan thread ini hanya hingga Gateway dimulai ulang",
  ...
  login: {
    ...
    deviceAuthMigration: {
      banner: "Peramban ini masih memerlukan persetujuan perangkat satu kali setelah pembaruan.",
