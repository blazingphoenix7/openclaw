...
export const fa: TranslationMap = {
  ...
  newSession: {
    ...
    incognito: "ناشناس",
    incognitoDescription: "این گفتگو را فقط تا زمان راه‌اندازی مجدد Gateway نگه دارید",
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "این مرورگر قدیمی به‌طور موقت در دسترس است. آن را روی HTTPS یا localhost دوباره باز کنید تا با هویت دستگاه ایمن شود.",
      pendingUnavailable: "درخواست جفت‌سازی مرورگر هنوز در دسترس نیست. لحظه‌ای دیگر دوباره تلاش کنید.",
      loadFailed: "بارگیری درخواست جفت‌سازی این مرورگر ممکن نبود: {error}",
      approvalFailed: "ایمن‌سازی این مرورگر ممکن نبود: {error}",
    },
  ...
  chat: {
    ...
    sessionSharing: {
      ...
      current: "قابلیت مشاهدهٔ گفتگو: {visibility}",
